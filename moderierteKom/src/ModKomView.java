...
{
    //Panels
    private List<anzeigeChat> chatCard = new ArrayList<anzeigeChat>(); // JPanels für Chats [!] evtl. Austausch durch "Chat" als Pane itsself (zukunft) the future is now
    ...
    public ModKomView(int anzahlChat)
    {
        ...
        closeButtonA.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
        ...
        closeButtonS.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
        ...
        banButton.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));

        unbanButton.setPreferredSize(new Dimension(100,50));
        unbanButton.setBorderPainted(false);
        unbanButton.setFocusPainted(false);
        unbanButton.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
        ...
        modModeButton.setBorder(BorderFactory.createEmptyBorder(5,5,20,5));
    ...
    void changerino(int id)
    {
        if(id==0)
        {
            changeChat(button.get(1));
        }
        else
        {
            changeChat(button.get(0));
        }
    ...
    void alPasswordField(KeyListener kl)
    {
        passwordField.addKeyListener(kl);
    }
    void alTextField(KeyListener kl)
    {
        for(int i = 0; i<chatCard.size(); i++)
        {
            chatCard.get(i).alTextField(kl);
        }
    }
